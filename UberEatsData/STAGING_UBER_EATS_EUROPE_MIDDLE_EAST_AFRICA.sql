...
CREATE TABLE [dbo].[STAGING_UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA]
(
...
ALTER TABLE [dbo].[STAGING_UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA] ADD  CONSTRAINT [DF_dbo_STAGING_UBER__EUROPE_MIDDLE_EAST_AFRICA_T_Created_TS]  DEFAULT (getdate()) FOR [T_Created_TS]
GO
