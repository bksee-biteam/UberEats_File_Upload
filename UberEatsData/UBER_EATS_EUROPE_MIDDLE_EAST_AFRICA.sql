CREATE TABLE [dbo].[UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA]
(
...
ALTER TABLE [dbo].[UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA] ADD  CONSTRAINT [DF_dbo_UBER_EUROPE_MIDDLE_EAST_AFRICA_T_Created_TS]  DEFAULT (getdate()) FOR [T_Created_TS]
GO

ALTER TABLE [dbo].[UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA] ADD  CONSTRAINT [DF_dbo_UBER_EUROPE_MIDDLE_EAST_AFRICA_Store_ID]  DEFAULT ('N/A') FOR [Store_ID]
GO



CREATE CLUSTERED INDEX idx_cs_uber_eats_france_belgium on  [dbo].[UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA] (Order_Date_OR_Refund_Date,Store_ID)
