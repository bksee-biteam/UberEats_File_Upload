...
BEGIN TRANSACTION;
		...
		BEGIN TRY
				...
				Select Store_Name, ISNULL(Store_ID,'N/A'), ISNULL(Order_ID,'N/A'), ISNULL(Order_Date_OR_Refund_Date,'1900-01-01'), Order_Accept_Time, Food_Sales_excluding_tax, Tax_On_Food_Sales, Food_sales_including_tax, Adjustments_excluding_tax, Tax_on_Adjustments, Promo_Spend_On_Food, Total_Sales_After_Adjustments_including_tax, Uber_Service_Fee, Dispatch_Fee, Tax_On_Dispatch_Fee, Misc_Payment_Description, Miscellaneous_Payments, Payout, ISNULL(Payout_Date,'1900-01-01'), Order_Status, T_Filename, T_Created_TS
				...
				ON T.Store_ID = ISNULL(S.Store_ID,'N/A')
					AND (T.Order_Date_Or_Refund_Date = ISNULL(S.Order_Date_OR_Refund_Date,'1900-01-01') OR (T.Payout_Date = ISNULL(S.Payout_Date,'1900-01-01')  AND S.Order_Date_Or_Refund_Date IS NULL) )
					--AND T.Order_Status = S.Order_Status
					AND T.Order_ID = ISNULL(S.Order_ID,'N/A')
...
BEGIN TRANSACTION;
		...
		-------------STAGING_UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA-------------------
				
				
				--DELETE 
				
				DELETE T
				FROM [dbo].[UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA] T INNER JOIN  [dbo].[STAGING_UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA]  S
				ON T.Store_ID = ISNULL(S.Store_ID,'N/A')
					AND (T.Order_Date_Or_Refund_Date = ISNULL(S.Order_Date_OR_Refund_Date,'1900-01-01') OR (T.Payout_Date = ISNULL(S.Payout_Date,'1900-01-01')  AND S.Order_Date_Or_Refund_Date IS NULL) )
					--AND T.Order_Status = S.Order_Status
					AND T.Order_ID = ISNULL(S.Order_ID,'N/A')
				...
				---INSERT
	 			...
	 			INSERT INTO [dbo].[UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA] WITH(TABLOCK)
				(Order_ID,Workflow_ID,Store_Name,Store_ID,Order_Date_OR_Refund_Date,Order_Accept_Time,Dining_Mode,Order_Channel,Food_Sales_excl_VAT,VAT1_on_Food_Sales,VAT2_on_Food_Sales,VAT3_on_Food_Sales,Food_Sales_incl_VAT,Discount_onFood_excl_VAT,VAT_1_on_Discount_on_Food,VAT_2_on_Discount_on_Food,VAT_2_on_Discount_on_Food_,Discount_on_Food_incl_VAT,Marketing_Service_Fee_Adjustment,Price_Adjustments_excluding_VAT,VAT_on_Price_Adjustments,Price_Adjustments_Including_VAT,Delivery_Fee_excl_VAT,VAT1_on_Delivery_Fee,VAT2_on_Delivery_Fee,VAT3_on_Delivery_Fee,Delivery_Fee_incl_VAT, [Special_Offer_On_Delivery_excl_VAT],[VAT_On Special Offer_On_Delivery],[Special_Offer_On_Delivery_incl_VAT], 	Total_Order_incl_VAT,Restaurant_to_Customer_Invoice_Link,Cost_of_Delivery_excl_VAT,VAT_on_cost_of_delivery,Cost_of_Delivery_incl_VAT,Courier_to_Restaurant_Invoice_Link,Uber_Service_Fees_before_Discount_ex_VAT,Service_Fee_Discount_ex_VAT,Uber_Service_Fee_after_Discount_ex_VAT,VAT_on_Uber_Service_Fees_after_Discount,Uber_Service_Fee_after_Discount_incl_VAT,Uber_to_Restaurant_Invoice_Link,VAT_Adjustment,Profit_on_Delivery,Gratuity,Misc_Payment_Description,Misc_Payments_incl_VAT,Payout,Payout_Date,Order_Status,T_Filename,T_Created_TS)
				
				SELECT ISNULL(Order_ID,'N/A'),Workflow_ID,Store_Name,ISNULL(Store_ID,'N/A'),ISNULL(Order_Date_OR_Refund_Date,'1900-01-01'),Order_Accept_Time,Dining_Mode,Order_Channel,Food_Sales_excl_VAT,VAT1_on_Food_Sales,VAT2_on_Food_Sales,VAT3_on_Food_Sales,Food_Sales_incl_VAT,Discount_onFood_excl_VAT,VAT_1_on_Discount_on_Food,VAT_2_on_Discount_on_Food,VAT_2_on_Discount_on_Food_,Discount_on_Food_incl_VAT,Marketing_Service_Fee_Adjustment,Price_Adjustments_excluding_VAT,VAT_on_Price_Adjustments,Price_Adjustments_Including_VAT,Delivery_Fee_excl_VAT,VAT1_on_Delivery_Fee,VAT2_on_Delivery_Fee,VAT3_on_Delivery_Fee,Delivery_Fee_incl_VAT,[Special_Offer_On_Delivery_excl_VAT],[VAT_On Special Offer_On_Delivery],[Special_Offer_On_Delivery_incl_VAT] ,Total_Order_incl_VAT,'' AS Restaurant_to_Customer_Invoice_Link,Cost_of_Delivery_excl_VAT,VAT_on_cost_of_delivery,Cost_of_Delivery_incl_VAT,'' AS Courier_to_Restaurant_Invoice_Link,Uber_Service_Fees_before_Discount_ex_VAT,Service_Fee_Discount_ex_VAT,Uber_Service_Fee_after_Discount_ex_VAT,VAT_on_Uber_Service_Fees_after_Discount,Uber_Service_Fee_after_Discount_incl_VAT,'' AS Uber_to_Restaurant_Invoice_Link,VAT_Adjustment,Profit_on_Delivery,Gratuity,Misc_Payment_Description,Misc_Payments_incl_VAT,Payout, ISNULL(Payout_Date,'1900-01-01'),Order_Status,T_Filename,T_Created_TS
				FROM  [dbo].[STAGING_UBER_EATS_EUROPE_MIDDLE_EAST_AFRICA]
