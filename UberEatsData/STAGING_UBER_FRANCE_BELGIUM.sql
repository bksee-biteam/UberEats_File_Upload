...
CREATE TABLE [dbo].[STAGING_UBER_EATS_FRANCE_BELGIUM]
(
...
ALTER TABLE [dbo].[STAGING_UBER_EATS_FRANCE_BELGIUM] ADD  CONSTRAINT [DF_dbo_STAGING_UBER_FRANCE_BELGIUM_T_Created_TS]  DEFAULT (getdate()) FOR [T_Created_TS]
GO
